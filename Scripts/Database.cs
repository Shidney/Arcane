...
public class Database : MonoBehaviour
{
    ...
    private void saveCardFile()
    {
        ...
        DataCard carta7 = new DataCard(6, "Daño heroico", "Inflinge <b>4p.</b> de daño", "Images/Arcanista", CardRarity.EPICA, CardType.HECHIZO, CardRaza.NIGROMANTE, 1, 0, 0);
        ...
        DataCard carta9 = new DataCard(8, "Demonio Aterrador", "<b>Grito de Batalla:</b>Inflinge <b>3p.</b> de daño a tu héroe", "Images/Arcanista", CardRarity.RARA, CardType.ESBIRRO, CardRaza.NIGROMANTE, 3, 4, 6);
        ...
        DataCard carta12 = new DataCard(11, "Hyonlian, el cosechador de almas", "<b>Suspiro de muerte</b>:Destruye tus esbirros y invoca 7 almas 3/3", "Images/Skeleton", CardRarity.LEGENDARIA, CardType.ESBIRRO, CardRaza.NIGROMANTE, 9, 8, 10);
        ...
        //Guardar en array
        DataCard[] array = new DataCard[15];//modificar este numero por el numero de cartas
        ...
        //
        prop = CardActionSet.GetMinionProperty(11);
        prop.Add(GameTag.DEATHWHISPER, true);
        CardActionSet.SetMinionProperty(11, prop);
